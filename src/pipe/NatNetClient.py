...
class NatNetClient:
    ...
    def __init__(self, conn):
        ...
        # Automatically detect this machine's ip address
        s = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        s.connect(("8.8.8.8", 80))
        self.localIPAddress = str(s.getsockname()[0])
        ...
        # Set this to a callback method of your choice to per-rigid-body data at each frame.
